\hypertarget{group__complexSYsolve}{}\section{complex}
\label{group__complexSYsolve}\index{complex@{complex}}
...
\hypertarget{group__complexSYsolve_ga7bfdf654eb5b41b318d5b8b3be55f575}{}\index{complex@{complex}!csysv@{csysv}}
\index{csysv@{csysv}!complex@{complex}}
\subsubsection[{csysv}]{\setlength{\rightskip}{0pt plus 5cm}subroutine csysv (
...
)}\label{group__complexSYsolve_ga7bfdf654eb5b41b318d5b8b3be55f575}


{\bfseries  C\+S\+Y\+S\+V computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for S\+Y matrices} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} CSYSV computes the solution to a complex system of linear equations
    A * X = B,
...
November 2011 
\end{DoxyDate}
\hypertarget{group__complexSYsolve_gaadb410c9b1f28931fe04501234603985}{}\index{complex@{complex}!csysv\+\_\+rook@{csysv\+\_\+rook}}
\index{csysv\+\_\+rook@{csysv\+\_\+rook}!complex@{complex}}
\subsubsection[{csysv\+\_\+rook}]{\setlength{\rightskip}{0pt plus 5cm}subroutine csysv\+\_\+rook (
\begin{DoxyParamCaption}
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
\item[{integer}]{N\+R\+H\+S, }
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__complexSYsolve_gaadb410c9b1f28931fe04501234603985}


{\bfseries  C\+S\+Y\+S\+V\+\_\+\+R\+O\+O\+K computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for S\+Y matrices} 
...
\end{DoxyParagraph}
\hypertarget{group__complexSYsolve_gab83ef6fbaf99306b967bf9053a3e6082}{}\index{complex@{complex}!csysvx@{csysvx}}
\index{csysvx@{csysvx}!complex@{complex}}
\subsubsection[{csysvx}]{\setlength{\rightskip}{0pt plus 5cm}subroutine csysvx (
\begin{DoxyParamCaption}
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__complexSYsolve_gab83ef6fbaf99306b967bf9053a3e6082}


{\bfseries  C\+S\+Y\+S\+V\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for S\+Y matrices} 
...
April 2012 
\end{DoxyDate}
\hypertarget{group__complexSYsolve_ga48da16f71d9aa75098b8c6d3c4007979}{}\index{complex@{complex}!csysvxx@{csysvxx}}
\index{csysvxx@{csysvxx}!complex@{complex}}
\subsubsection[{csysvxx}]{\setlength{\rightskip}{0pt plus 5cm}subroutine csysvxx (
\begin{DoxyParamCaption}
\item[{character}]{F\+A\+C\+T, }
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__complexSYsolve_ga48da16f71d9aa75098b8c6d3c4007979}


{\bfseries  C\+S\+Y\+S\+V\+X\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for S\+Y matrices} 
