\hypertarget{zlalsa_8f}{}\section{packages/lapack-\/3.5.0/\+S\+R\+C/zlalsa.f File Reference}
\label{zlalsa_8f}\index{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/zlalsa.\+f@{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/zlalsa.\+f}}
...
\hypertarget{zlalsa_8f_adfb51762868d0b8a6ba8a5ccbd596544}{}\index{zlalsa.\+f@{zlalsa.\+f}!zlalsa@{zlalsa}}
\index{zlalsa@{zlalsa}!zlalsa.\+f@{zlalsa.\+f}}
\subsubsection[{zlalsa}]{\setlength{\rightskip}{0pt plus 5cm}subroutine zlalsa (
...
\item[{integer}]{L\+D\+B, }
\item[{{\bf complex}$\ast$16, dimension( ldbx, $\ast$ )}]{B\+X, }
...
)}\label{zlalsa_8f_adfb51762868d0b8a6ba8a5ccbd596544}


{\bfseries Z\+L\+A\+L\+S\+A} computes the S\+V\+D of the coefficient matrix in compact form. Used by sgelsd. 
