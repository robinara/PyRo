\hypertarget{group__doubleSYsolve}{}\section{double}
\label{group__doubleSYsolve}\index{double@{double}}
...
\begin{DoxyCompactList}\small\item\em {\bfseries  D\+S\+Y\+S\+V\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for S\+Y matrices} \end{DoxyCompactList}\end{DoxyCompactItemize}


\subsection{Detailed Description}
This is the group of double solve driver functions for S\+Y matrices 

\subsection{Function Documentation}
\hypertarget{group__doubleSYsolve_ga9995c47692c9885ed5d6a6b431686f41}{}\index{double@{double}!dsysv@{dsysv}}
\index{dsysv@{dsysv}!double@{double}}
\subsubsection[{dsysv}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dsysv (
...
)}\label{group__doubleSYsolve_ga9995c47692c9885ed5d6a6b431686f41}


{\bfseries  D\+S\+Y\+S\+V computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for S\+Y matrices} 
...
November 2011 
\end{DoxyDate}
\hypertarget{group__doubleSYsolve_ga1b3fcf55f485dd01efeb8435dccf9215}{}\index{double@{double}!dsysv\+\_\+rook@{dsysv\+\_\+rook}}
\index{dsysv\+\_\+rook@{dsysv\+\_\+rook}!double@{double}}
\subsubsection[{dsysv\+\_\+rook}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dsysv\+\_\+rook (
\begin{DoxyParamCaption}
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
\item[{integer}]{N\+R\+H\+S, }
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__doubleSYsolve_ga1b3fcf55f485dd01efeb8435dccf9215}


{\bfseries  D\+S\+Y\+S\+V\+\_\+\+R\+O\+O\+K computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for S\+Y matrices} 
...
\end{DoxyParagraph}
\hypertarget{group__doubleSYsolve_ga183787a5a4cb471abe442815b0e44b35}{}\index{double@{double}!dsysvx@{dsysvx}}
\index{dsysvx@{dsysvx}!double@{double}}
\subsubsection[{dsysvx}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dsysvx (
\begin{DoxyParamCaption}
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__doubleSYsolve_ga183787a5a4cb471abe442815b0e44b35}


{\bfseries  D\+S\+Y\+S\+V\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for S\+Y matrices} 
