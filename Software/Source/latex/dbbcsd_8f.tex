\hypertarget{dbbcsd_8f}{}\section{packages/lapack-\/3.5.0/\+S\+R\+C/dbbcsd.f File Reference}
\label{dbbcsd_8f}\index{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/dbbcsd.\+f@{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/dbbcsd.\+f}}
...
\hypertarget{dbbcsd_8f_a27a367582a76c7b48a8bf3eed068e216}{}\index{dbbcsd.\+f@{dbbcsd.\+f}!dbbcsd@{dbbcsd}}
\index{dbbcsd@{dbbcsd}!dbbcsd.\+f@{dbbcsd.\+f}}
\subsubsection[{dbbcsd}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dbbcsd (
...
\item[{double {\bf precision}, dimension( $\ast$ )}]{B11\+D, }
\item[{double {\bf precision}, dimension( $\ast$ )}]{B11\+E, }
\item[{double {\bf precision}, dimension( $\ast$ )}]{B12\+D, }
\item[{double {\bf precision}, dimension( $\ast$ )}]{B12\+E, }
\item[{double {\bf precision}, dimension( $\ast$ )}]{B21\+D, }
\item[{double {\bf precision}, dimension( $\ast$ )}]{B21\+E, }
\item[{double {\bf precision}, dimension( $\ast$ )}]{B22\+D, }
\item[{double {\bf precision}, dimension( $\ast$ )}]{B22\+E, }
\item[{double {\bf precision}, dimension( $\ast$ )}]{W\+O\+R\+K, }
\item[{integer}]{L\+W\+O\+R\+K, }
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{dbbcsd_8f_a27a367582a76c7b48a8bf3eed068e216}


{\bfseries D\+B\+B\+C\+S\+D} 
