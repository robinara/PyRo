\hypertarget{group__complexSYauxiliary}{}\section{complex}
\label{group__complexSYauxiliary}\index{complex@{complex}}
...
\hypertarget{group__complexSYauxiliary_gad7bdd5e02c8e280c12ff9fba3c712dd6}{}\index{complex@{complex}!claesy@{claesy}}
\index{claesy@{claesy}!complex@{complex}}
\subsubsection[{claesy}]{\setlength{\rightskip}{0pt plus 5cm}subroutine claesy (
\begin{DoxyParamCaption}
\item[{{\bf complex}}]{A, }
\item[{{\bf complex}}]{B, }
\item[{{\bf complex}}]{C, }
\item[{{\bf complex}}]{R\+T1, }
\item[{{\bf complex}}]{R\+T2, }
\item[{{\bf complex}}]{E\+V\+S\+C\+A\+L, }
\item[{{\bf complex}}]{C\+S1, }
\item[{{\bf complex}}]{S\+N1}
\end{DoxyParamCaption}
)}\label{group__complexSYauxiliary_gad7bdd5e02c8e280c12ff9fba3c712dd6}


{\bfseries C\+L\+A\+E\+S\+Y} computes the eigenvalues and eigenvectors of a 2-\/by-\/2 complex symmetric matrix. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} CLAESY computes the eigendecomposition of a 2-by-2 symmetric matrix
    ( ( A, B );( B, C ) )
...
September 2012 
\end{DoxyDate}
\hypertarget{group__complexSYauxiliary_gad2c86a28190eb12c91cda1c4faef5df7}{}\index{complex@{complex}!clansy@{clansy}}
\index{clansy@{clansy}!complex@{complex}}
\subsubsection[{clansy}]{\setlength{\rightskip}{0pt plus 5cm}real {\bf function} clansy (
\begin{DoxyParamCaption}
...
\end{DoxyParamCaption}
)}\label{group__complexSYauxiliary_gad2c86a28190eb12c91cda1c4faef5df7}


{\bfseries C\+L\+A\+N\+S\+Y} returns the value of the 1-\/norm, or the Frobenius norm, or the infinity norm, or the element of largest absolute value of a complex symmetric matrix. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} CLANSY  returns the value of the one norm,  or the Frobenius norm, or
 the  infinity norm,  or the  element of  largest absolute value  of a
 complex symmetric matrix A.\end{DoxyVerb}

\end{DoxyParagraph}
\begin{DoxyReturn}{Returns}
C\+L\+A\+N\+S\+Y \begin{DoxyVerb}    CLANSY = ( max(abs(A(i,j))), NORM = 'M' or 'm'
             (
...
September 2012 
\end{DoxyDate}
\hypertarget{group__complexSYauxiliary_gab12daf202264e97ef334a0d8125497b8}{}\index{complex@{complex}!claqsy@{claqsy}}
\index{claqsy@{claqsy}!complex@{complex}}
\subsubsection[{claqsy}]{\setlength{\rightskip}{0pt plus 5cm}subroutine claqsy (
\begin{DoxyParamCaption}
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
\item[{{\bf complex}, dimension( lda, $\ast$ )}]{A, }
...
\end{DoxyParamCaption}
)}\label{group__complexSYauxiliary_gab12daf202264e97ef334a0d8125497b8}


{\bfseries C\+L\+A\+Q\+S\+Y} scales a symmetric/\+Hermitian matrix, using scaling factors computed by spoequ. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} CLAQSY equilibrates a symmetric matrix A using the scaling factors
...
September 2012 
\end{DoxyDate}
\hypertarget{group__complexSYauxiliary_gae013512af4fd2c59629f1708ca4de36a}{}\index{complex@{complex}!csymv@{csymv}}
\index{csymv@{csymv}!complex@{complex}}
\subsubsection[{csymv}]{\setlength{\rightskip}{0pt plus 5cm}subroutine csymv (
\begin{DoxyParamCaption}
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
...
\end{DoxyParamCaption}
)}\label{group__complexSYauxiliary_gae013512af4fd2c59629f1708ca4de36a}


{\bfseries C\+S\+Y\+M\+V} computes a matrix-\/vector product for a complex symmetric matrix. 
...
September 2012 
\end{DoxyDate}
\hypertarget{group__complexSYauxiliary_gab7fbaf7c4477110907f682b250b24abe}{}\index{complex@{complex}!csyr@{csyr}}
\index{csyr@{csyr}!complex@{complex}}
\subsubsection[{csyr}]{\setlength{\rightskip}{0pt plus 5cm}subroutine csyr (
\begin{DoxyParamCaption}
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
\item[{{\bf complex}}]{A\+L\+P\+H\+A, }
...
\item[{integer}]{L\+D\+A}
\end{DoxyParamCaption}
)}\label{group__complexSYauxiliary_gab7fbaf7c4477110907f682b250b24abe}


{\bfseries C\+S\+Y\+R} performs the symmetric rank-\/1 update of a complex symmetric matrix. 
...
September 2012 
\end{DoxyDate}
\hypertarget{group__complexSYauxiliary_ga9f9a3d10086d7de0fcb0a4732c2e9b21}{}\index{complex@{complex}!csyswapr@{csyswapr}}
\index{csyswapr@{csyswapr}!complex@{complex}}
\subsubsection[{csyswapr}]{\setlength{\rightskip}{0pt plus 5cm}subroutine csyswapr (
\begin{DoxyParamCaption}
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
...
\item[{integer}]{I2}
\end{DoxyParamCaption}
)}\label{group__complexSYauxiliary_ga9f9a3d10086d7de0fcb0a4732c2e9b21}


{\bfseries C\+S\+Y\+S\+W\+A\+P\+R} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} CSYSWAPR applies an elementary permutation on the rows and the columns of
...
November 2011 
\end{DoxyDate}
\hypertarget{group__complexSYauxiliary_ga82a880920a428b8ac1203547b0e74d6b}{}\index{complex@{complex}!ctgsy2@{ctgsy2}}
\index{ctgsy2@{ctgsy2}!complex@{complex}}
\subsubsection[{ctgsy2}]{\setlength{\rightskip}{0pt plus 5cm}subroutine ctgsy2 (
\begin{DoxyParamCaption}
...
\end{DoxyParamCaption}
)}\label{group__complexSYauxiliary_ga82a880920a428b8ac1203547b0e74d6b}


{\bfseries C\+T\+G\+S\+Y2} solves the generalized Sylvester equation (unblocked algorithm). 
