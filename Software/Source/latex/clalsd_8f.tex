\hypertarget{clalsd_8f}{}\section{packages/lapack-\/3.5.0/\+S\+R\+C/clalsd.f File Reference}
\label{clalsd_8f}\index{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/clalsd.\+f@{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/clalsd.\+f}}
...
\hypertarget{clalsd_8f_a26c9ab8dc8642c18e3cbde5769b8138d}{}\index{clalsd.\+f@{clalsd.\+f}!clalsd@{clalsd}}
\index{clalsd@{clalsd}!clalsd.\+f@{clalsd.\+f}}
\subsubsection[{clalsd}]{\setlength{\rightskip}{0pt plus 5cm}subroutine clalsd (
...
)}\label{clalsd_8f_a26c9ab8dc8642c18e3cbde5769b8138d}


{\bfseries C\+L\+A\+L\+S\+D} uses the singular value decomposition of \hyperlink{classA}{A} to solve the least squares problem. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} CLALSD uses the singular value decomposition of A to solve the least
