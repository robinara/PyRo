\hypertarget{cgsisx_8c}{}\section{packages/scipy-\/0.14.0/scipy/sparse/linalg/dsolve/\+Super\+L\+U/\+S\+R\+C/cgsisx.c File Reference}
\label{cgsisx_8c}\index{packages/scipy-\/0.\+14.\+0/scipy/sparse/linalg/dsolve/\+Super\+L\+U/\+S\+R\+C/cgsisx.\+c@{packages/scipy-\/0.\+14.\+0/scipy/sparse/linalg/dsolve/\+Super\+L\+U/\+S\+R\+C/cgsisx.\+c}}
...
\item 
void \hyperlink{cgsisx_8c_aadff8c65cafef191464b3d10bbcbbe7c}{cgsisx} (\hyperlink{structsuperlu__options__t}{superlu\+\_\+options\+\_\+t} $\ast$options, \hyperlink{structSuperMatrix}{Super\+Matrix} $\ast$\hyperlink{classA}{A}, int $\ast$perm\+\_\+c, int $\ast$perm\+\_\+r, int $\ast$etree, char $\ast$equed, float $\ast$R, float $\ast$C, \hyperlink{structSuperMatrix}{Super\+Matrix} $\ast$L, \hyperlink{structSuperMatrix}{Super\+Matrix} $\ast$U, void $\ast$work, int lwork, \hyperlink{structSuperMatrix}{Super\+Matrix} $\ast$B, \hyperlink{structSuperMatrix}{Super\+Matrix} $\ast$X, float $\ast$recip\+\_\+pivot\+\_\+growth, float $\ast$rcond, \hyperlink{structmem__usage__t}{mem\+\_\+usage\+\_\+t} $\ast$mem\+\_\+usage, \hyperlink{structSuperLUStat__t}{Super\+L\+U\+Stat\+\_\+t} $\ast$stat, int $\ast$info)
...
\hypertarget{cgsisx_8c_aadff8c65cafef191464b3d10bbcbbe7c}{}\index{cgsisx.\+c@{cgsisx.\+c}!cgsisx@{cgsisx}}
\index{cgsisx@{cgsisx}!cgsisx.\+c@{cgsisx.\+c}}
...
)}\label{cgsisx_8c_aadff8c65cafef191464b3d10bbcbbe7c}
...
\begin{DoxyPre}
\begin{DoxyEnumerate}
\item If \hyperlink{classA}{A} is stored row-wise (A->Stype = SLU\_NR), apply the above algorithm
 to the transpose of \hyperlink{classA}{A}:
