\hypertarget{group__realGBauxiliary}{}\section{real}
\label{group__realGBauxiliary}\index{real@{real}}
...
\hypertarget{group__realGBauxiliary_gaf4b60512534024c921af88def5b806b7}{}\index{real@{real}!slangb@{slangb}}
\index{slangb@{slangb}!real@{real}}
\subsubsection[{slangb}]{\setlength{\rightskip}{0pt plus 5cm}real {\bf function} slangb (
...
)}\label{group__realGBauxiliary_gaf4b60512534024c921af88def5b806b7}


{\bfseries S\+L\+A\+N\+G\+B} returns the value of the 1-\/norm, Frobenius norm, infinity-\/norm, or the largest absolute value of any element of general band matrix. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} SLANGB  returns the value of the one norm,  or the Frobenius norm, or
 the  infinity norm,  or the element of  largest absolute value  of an
 n by n band matrix  A,  with kl sub-diagonals and ku super-diagonals.\end{DoxyVerb}

\end{DoxyParagraph}
\begin{DoxyReturn}{Returns}
S\+L\+A\+N\+G\+B \begin{DoxyVerb}    SLANGB = ( max(abs(A(i,j))), NORM = 'M' or 'm'
             (
...
September 2012 
\end{DoxyDate}
\hypertarget{group__realGBauxiliary_ga4041f9392fd5e5137bcbb2ed29ae3b14}{}\index{real@{real}!slaqgb@{slaqgb}}
\index{slaqgb@{slaqgb}!real@{real}}
\subsubsection[{slaqgb}]{\setlength{\rightskip}{0pt plus 5cm}subroutine slaqgb (
\begin{DoxyParamCaption}
\item[{integer}]{M, }
\item[{integer}]{N, }
\item[{integer}]{K\+L, }
...
\end{DoxyParamCaption}
)}\label{group__realGBauxiliary_ga4041f9392fd5e5137bcbb2ed29ae3b14}


{\bfseries S\+L\+A\+Q\+G\+B} scales a general band matrix, using row and column scaling factors computed by sgbequ. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} SLAQGB equilibrates a general M by N band matrix A with KL
