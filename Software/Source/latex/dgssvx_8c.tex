\hypertarget{dgssvx_8c}{}\section{packages/scipy-\/0.14.0/scipy/sparse/linalg/dsolve/\+Super\+L\+U/\+S\+R\+C/dgssvx.c File Reference}
\label{dgssvx_8c}\index{packages/scipy-\/0.\+14.\+0/scipy/sparse/linalg/dsolve/\+Super\+L\+U/\+S\+R\+C/dgssvx.\+c@{packages/scipy-\/0.\+14.\+0/scipy/sparse/linalg/dsolve/\+Super\+L\+U/\+S\+R\+C/dgssvx.\+c}}
...
\item 
void \hyperlink{dgssvx_8c_aa463b60835d9bca4a4bb1386076d1488}{dgssvx} (\hyperlink{structsuperlu__options__t}{superlu\+\_\+options\+\_\+t} $\ast$options, \hyperlink{structSuperMatrix}{Super\+Matrix} $\ast$\hyperlink{classA}{A}, int $\ast$perm\+\_\+c, int $\ast$perm\+\_\+r, int $\ast$etree, char $\ast$equed, double $\ast$R, double $\ast$C, \hyperlink{structSuperMatrix}{Super\+Matrix} $\ast$L, \hyperlink{structSuperMatrix}{Super\+Matrix} $\ast$U, void $\ast$work, int lwork, \hyperlink{structSuperMatrix}{Super\+Matrix} $\ast$B, \hyperlink{structSuperMatrix}{Super\+Matrix} $\ast$X, double $\ast$recip\+\_\+pivot\+\_\+growth, double $\ast$rcond, double $\ast$ferr, double $\ast$berr, \hyperlink{structmem__usage__t}{mem\+\_\+usage\+\_\+t} $\ast$mem\+\_\+usage, \hyperlink{structSuperLUStat__t}{Super\+L\+U\+Stat\+\_\+t} $\ast$stat, int $\ast$info)
...
\hypertarget{dgssvx_8c_aa463b60835d9bca4a4bb1386076d1488}{}\index{dgssvx.\+c@{dgssvx.\+c}!dgssvx@{dgssvx}}
\index{dgssvx@{dgssvx}!dgssvx.\+c@{dgssvx.\+c}}
...
)}\label{dgssvx_8c_aa463b60835d9bca4a4bb1386076d1488}
