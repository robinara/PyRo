\hypertarget{csysvx_8f}{}\section{packages/lapack-\/3.5.0/\+S\+R\+C/csysvx.f File Reference}
\label{csysvx_8f}\index{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/csysvx.\+f@{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/csysvx.\+f}}
...
\begin{DoxyCompactList}\small\item\em {\bfseries  C\+S\+Y\+S\+V\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for S\+Y matrices} \end{DoxyCompactList}\end{DoxyCompactItemize}
