\hypertarget{dlaqps_8f}{}\section{packages/lapack-\/3.5.0/\+S\+R\+C/dlaqps.f File Reference}
\label{dlaqps_8f}\index{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/dlaqps.\+f@{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/dlaqps.\+f}}
...
\hypertarget{dlaqps_8f_ae9390b8aa28d639a2e67f2aa33583e97}{}\index{dlaqps.\+f@{dlaqps.\+f}!dlaqps@{dlaqps}}
\index{dlaqps@{dlaqps}!dlaqps.\+f@{dlaqps.\+f}}
\subsubsection[{dlaqps}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dlaqps (
...
\item[{double {\bf precision}, dimension( $\ast$ )}]{A\+U\+X\+V, }
\item[{double {\bf precision}, dimension( ldf, $\ast$ )}]{F, }
\item[{integer}]{L\+D\+F}
\end{DoxyParamCaption}
)}\label{dlaqps_8f_ae9390b8aa28d639a2e67f2aa33583e97}


{\bfseries D\+L\+A\+Q\+P\+S} computes a step of Q\+R factorization with column pivoting of a real m-\/by-\/n matrix \hyperlink{classA}{A} by using B\+L\+A\+S level 3. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} DLAQPS computes a step of QR factorization with column pivoting
