\hypertarget{clalsa_8f}{}\section{packages/lapack-\/3.5.0/\+S\+R\+C/clalsa.f File Reference}
\label{clalsa_8f}\index{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/clalsa.\+f@{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/clalsa.\+f}}
...
\hypertarget{clalsa_8f_afba920049d8d99f99e48e408ce1e2591}{}\index{clalsa.\+f@{clalsa.\+f}!clalsa@{clalsa}}
\index{clalsa@{clalsa}!clalsa.\+f@{clalsa.\+f}}
\subsubsection[{clalsa}]{\setlength{\rightskip}{0pt plus 5cm}subroutine clalsa (
...
\item[{integer}]{L\+D\+B, }
\item[{{\bf complex}, dimension( ldbx, $\ast$ )}]{B\+X, }
...
)}\label{clalsa_8f_afba920049d8d99f99e48e408ce1e2591}


{\bfseries C\+L\+A\+L\+S\+A} computes the S\+V\+D of the coefficient matrix in compact form. Used by sgelsd. 
