\hypertarget{group__complex16GEauxiliary}{}\section{complex16}
\label{group__complex16GEauxiliary}\index{complex16@{complex16}}
...
\begin{DoxyCompactList}\small\item\em {\bfseries Z\+L\+A\+Q\+G\+E} scales a general rectangular matrix, using row and column scaling factors computed by sgeequ. \end{DoxyCompactList}\item 
...
This is the group of complex16 auxiliary functions for G\+E matrices 

\subsection{Function Documentation}
\hypertarget{group__complex16GEauxiliary_ga9adcef3bc45139ea3693275252880c29}{}\index{complex16@{complex16}!zgesc2@{zgesc2}}
\index{zgesc2@{zgesc2}!complex16@{complex16}}
\subsubsection[{zgesc2}]{\setlength{\rightskip}{0pt plus 5cm}subroutine zgesc2 (
...
)}\label{group__complex16GEauxiliary_ga9adcef3bc45139ea3693275252880c29}


{\bfseries Z\+G\+E\+S\+C2} solves a system of linear equations using the L\+U factorization with complete pivoting computed by sgetc2. 
...
\end{DoxyParagraph}
\hypertarget{group__complex16GEauxiliary_gae5d1dc8c626b248e836d865f428aa399}{}\index{complex16@{complex16}!zgetc2@{zgetc2}}
\index{zgetc2@{zgetc2}!complex16@{complex16}}
\subsubsection[{zgetc2}]{\setlength{\rightskip}{0pt plus 5cm}subroutine zgetc2 (
\begin{DoxyParamCaption}
\item[{integer}]{N, }
\item[{{\bf complex}$\ast$16, dimension( lda, $\ast$ )}]{A, }
\item[{integer}]{L\+D\+A, }
...
\end{DoxyParamCaption}
)}\label{group__complex16GEauxiliary_gae5d1dc8c626b248e836d865f428aa399}


{\bfseries Z\+G\+E\+T\+C2} computes the L\+U factorization with complete pivoting of the general n-\/by-\/n matrix. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} ZGETC2 computes an LU factorization, using complete pivoting, of the
...
Bo Kagstrom and Peter Poromaa, Department of Computing Science, Umea University, S-\/901 87 Umea, Sweden. 
\end{DoxyParagraph}
\hypertarget{group__complex16GEauxiliary_ga7908bb12a6f02dbfa4d5a92a27c0e9b7}{}\index{complex16@{complex16}!zlange@{zlange}}
\index{zlange@{zlange}!complex16@{complex16}}
\subsubsection[{zlange}]{\setlength{\rightskip}{0pt plus 5cm}double {\bf precision} {\bf function} zlange (
\begin{DoxyParamCaption}
...
\end{DoxyParamCaption}
)}\label{group__complex16GEauxiliary_ga7908bb12a6f02dbfa4d5a92a27c0e9b7}


{\bfseries Z\+L\+A\+N\+G\+E} returns the value of the 1-\/norm, Frobenius norm, infinity-\/norm, or the largest absolute value of any element of a general rectangular matrix. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} ZLANGE  returns the value of the one norm,  or the Frobenius norm, or
 the  infinity norm,  or the  element of  largest absolute value  of a
 complex matrix A.\end{DoxyVerb}

\end{DoxyParagraph}
\begin{DoxyReturn}{Returns}
Z\+L\+A\+N\+G\+E \begin{DoxyVerb}    ZLANGE = ( max(abs(A(i,j))), NORM = 'M' or 'm'
             (
...
September 2012 
\end{DoxyDate}
\hypertarget{group__complex16GEauxiliary_gad847103d204693cb8b9356ff7adfb9b1}{}\index{complex16@{complex16}!zlaqge@{zlaqge}}
\index{zlaqge@{zlaqge}!complex16@{complex16}}
\subsubsection[{zlaqge}]{\setlength{\rightskip}{0pt plus 5cm}subroutine zlaqge (
\begin{DoxyParamCaption}
\item[{integer}]{M, }
\item[{integer}]{N, }
\item[{{\bf complex}$\ast$16, dimension( lda, $\ast$ )}]{A, }
...
\end{DoxyParamCaption}
)}\label{group__complex16GEauxiliary_gad847103d204693cb8b9356ff7adfb9b1}


{\bfseries Z\+L\+A\+Q\+G\+E} scales a general rectangular matrix, using row and column scaling factors computed by sgeequ. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} ZLAQGE equilibrates a general M by N matrix A using the row and
...
September 2012 
\end{DoxyDate}
\hypertarget{group__complex16GEauxiliary_ga9b8dc8981846f349260173092928b059}{}\index{complex16@{complex16}!ztgex2@{ztgex2}}
\index{ztgex2@{ztgex2}!complex16@{complex16}}
\subsubsection[{ztgex2}]{\setlength{\rightskip}{0pt plus 5cm}subroutine ztgex2 (
\begin{DoxyParamCaption}
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__complex16GEauxiliary_ga9b8dc8981846f349260173092928b059}


{\bfseries Z\+T\+G\+E\+X2} swaps adjacent diagonal blocks in an upper (quasi) triangular matrix pair by an unitary equivalence transformation. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} ZTGEX2 swaps adjacent diagonal 1 by 1 blocks (A11,B11) and (A22,B22)
