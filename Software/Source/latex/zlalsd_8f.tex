\hypertarget{zlalsd_8f}{}\section{packages/lapack-\/3.5.0/\+S\+R\+C/zlalsd.f File Reference}
\label{zlalsd_8f}\index{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/zlalsd.\+f@{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/zlalsd.\+f}}
...
\hypertarget{zlalsd_8f_a469113fb08a70d0fa24940f949a04d6c}{}\index{zlalsd.\+f@{zlalsd.\+f}!zlalsd@{zlalsd}}
\index{zlalsd@{zlalsd}!zlalsd.\+f@{zlalsd.\+f}}
\subsubsection[{zlalsd}]{\setlength{\rightskip}{0pt plus 5cm}subroutine zlalsd (
...
)}\label{zlalsd_8f_a469113fb08a70d0fa24940f949a04d6c}


{\bfseries Z\+L\+A\+L\+S\+D} uses the singular value decomposition of \hyperlink{classA}{A} to solve the least squares problem. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} ZLALSD uses the singular value decomposition of A to solve the least
