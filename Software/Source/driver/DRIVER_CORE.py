 ##@package docstring
#Complete Driver Collection of supported devices by FROST OS. Supported devices datasheets can be found at www.ids-labs.me.
#
#Version 0.1
...
class PCA9865:
	...
	def __init__(self,port,busnum=-1, debug=False):
	...
	def setFreq(self,freq):
		...
		if ((freq >=self.FREQ_MIN) and (freq<=self.FREQ_MAX)):
			...
			self.i2c.write8(self.__PCA9685_MODE1,0x0)
			self.i2c.write8(self.__PCA9685_PRESCALE, prescale)
