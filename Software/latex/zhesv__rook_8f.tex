\hypertarget{zhesv__rook_8f}{}\section{packages/lapack-\/3.5.0/\+S\+R\+C/zhesv\+\_\+rook.f File Reference}
\label{zhesv__rook_8f}\index{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/zhesv\+\_\+rook.\+f@{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/zhesv\+\_\+rook.\+f}}
...
\hypertarget{zhesv__rook_8f_a566409efe6c6b00a221afd360c73c5ba}{}\index{zhesv\+\_\+rook.\+f@{zhesv\+\_\+rook.\+f}!zhesv\+\_\+rook@{zhesv\+\_\+rook}}
\index{zhesv\+\_\+rook@{zhesv\+\_\+rook}!zhesv\+\_\+rook.\+f@{zhesv\+\_\+rook.\+f}}
\subsubsection[{zhesv\+\_\+rook}]{\setlength{\rightskip}{0pt plus 5cm}subroutine zhesv\+\_\+rook (
...
)}\label{zhesv__rook_8f_a566409efe6c6b00a221afd360c73c5ba}


{\bfseries Z\+H\+E\+S\+V\+\_\+\+R\+O\+O\+K} computes the solution to a system of linear equations \hyperlink{classA}{A} $\ast$ X = B for H\+E matrices using the bounded Bunch-\/\+Kaufman (\char`\"{}rook\char`\"{}) diagonal pivoting method 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} ZHESV_ROOK computes the solution to a complex system of linear equations
    A * X = B,
 ...
 of equations A * X = B by calling ZHETRS_ROOK (uses BLAS 2).\end{DoxyVerb}
