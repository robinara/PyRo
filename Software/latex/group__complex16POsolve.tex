\hypertarget{group__complex16POsolve}{}\section{complex16}
\label{group__complex16POsolve}\index{complex16@{complex16}}
...
\hypertarget{group__complex16POsolve_gae1f1548257a84b4328773c60eefb8934}{}\index{complex16@{complex16}!zcposv@{zcposv}}
\index{zcposv@{zcposv}!complex16@{complex16}}
\subsubsection[{zcposv}]{\setlength{\rightskip}{0pt plus 5cm}subroutine zcposv (
...
)}\label{group__complex16POsolve_gae1f1548257a84b4328773c60eefb8934}


{\bfseries  Z\+C\+P\+O\+S\+V computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for P\+O matrices} 
...
November 2011 
\end{DoxyDate}
\hypertarget{group__complex16POsolve_ga58f7fd3a95eb2994b1caec327ec75895}{}\index{complex16@{complex16}!zposv@{zposv}}
\index{zposv@{zposv}!complex16@{complex16}}
\subsubsection[{zposv}]{\setlength{\rightskip}{0pt plus 5cm}subroutine zposv (
\begin{DoxyParamCaption}
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
\item[{integer}]{N\+R\+H\+S, }
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__complex16POsolve_ga58f7fd3a95eb2994b1caec327ec75895}


{\bfseries  Z\+P\+O\+S\+V computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for P\+O matrices} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} ZPOSV computes the solution to a complex system of linear equations
    A * X = B,
 where A is an N-by-N Hermitian positive definite matrix and X and B
 are N-by-NRHS matrices.
...
November 2011 
\end{DoxyDate}
\hypertarget{group__complex16POsolve_gae86e9b8504b15462b291b17032195e29}{}\index{complex16@{complex16}!zposvx@{zposvx}}
\index{zposvx@{zposvx}!complex16@{complex16}}
\subsubsection[{zposvx}]{\setlength{\rightskip}{0pt plus 5cm}subroutine zposvx (
\begin{DoxyParamCaption}
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__complex16POsolve_gae86e9b8504b15462b291b17032195e29}


{\bfseries  Z\+P\+O\+S\+V\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for P\+O matrices} 
...
April 2012 
\end{DoxyDate}
\hypertarget{group__complex16POsolve_ga3536bbd664c6152bca5e47cffd0c6676}{}\index{complex16@{complex16}!zposvxx@{zposvxx}}
\index{zposvxx@{zposvxx}!complex16@{complex16}}
\subsubsection[{zposvxx}]{\setlength{\rightskip}{0pt plus 5cm}subroutine zposvxx (
\begin{DoxyParamCaption}
\item[{character}]{F\+A\+C\+T, }
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__complex16POsolve_ga3536bbd664c6152bca5e47cffd0c6676}


{\bfseries  Z\+P\+O\+S\+V\+X\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for P\+O matrices} 
