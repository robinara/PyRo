\hypertarget{group__doubleSYauxiliary}{}\section{double}
\label{group__doubleSYauxiliary}\index{double@{double}}
...
\begin{DoxyCompactList}\small\item\em {\bfseries D\+S\+Y\+S\+W\+A\+P\+R} applies an elementary permutation on the rows and columns of a symmetric matrix. \end{DoxyCompactList}\item 
...
This is the group of double auxiliary functions for S\+Y matrices 

\subsection{Function Documentation}
\hypertarget{group__doubleSYauxiliary_ga8e0d957efd6f93764d9bc98a7aa1927a}{}\index{double@{double}!dlansy@{dlansy}}
\index{dlansy@{dlansy}!double@{double}}
\subsubsection[{dlansy}]{\setlength{\rightskip}{0pt plus 5cm}double {\bf precision} {\bf function} dlansy (
...
)}\label{group__doubleSYauxiliary_ga8e0d957efd6f93764d9bc98a7aa1927a}


{\bfseries D\+L\+A\+N\+S\+Y} returns the value of the 1-\/norm, or the Frobenius norm, or the infinity norm, or the element of largest absolute value of a real symmetric matrix. 
...
September 2012 
\end{DoxyDate}
\hypertarget{group__doubleSYauxiliary_gaf752e7a2738ba60307c9d41d171099b0}{}\index{double@{double}!dlaqsy@{dlaqsy}}
\index{dlaqsy@{dlaqsy}!double@{double}}
\subsubsection[{dlaqsy}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dlaqsy (
\begin{DoxyParamCaption}
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
\item[{double {\bf precision}, dimension( lda, $\ast$ )}]{A, }
...
\end{DoxyParamCaption}
)}\label{group__doubleSYauxiliary_gaf752e7a2738ba60307c9d41d171099b0}


{\bfseries D\+L\+A\+Q\+S\+Y} scales a symmetric/\+Hermitian matrix, using scaling factors computed by spoequ. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} DLAQSY equilibrates a symmetric matrix A using the scaling factors
...
September 2012 
\end{DoxyDate}
\hypertarget{group__doubleSYauxiliary_gaf104dd54134c1a4ddb0d573ff9fe6d06}{}\index{double@{double}!dlasy2@{dlasy2}}
\index{dlasy2@{dlasy2}!double@{double}}
\subsubsection[{dlasy2}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dlasy2 (
\begin{DoxyParamCaption}
...
\item[{integer}]{N1, }
\item[{integer}]{N2, }
\item[{double {\bf precision}, dimension( ldtl, $\ast$ )}]{T\+L, }
\item[{integer}]{L\+D\+T\+L, }
\item[{double {\bf precision}, dimension( ldtr, $\ast$ )}]{T\+R, }
...
\end{DoxyParamCaption}
)}\label{group__doubleSYauxiliary_gaf104dd54134c1a4ddb0d573ff9fe6d06}


{\bfseries D\+L\+A\+S\+Y2} solves the Sylvester matrix equation where the matrices are of order 1 or 2. 
...
September 2012 
\end{DoxyDate}
\hypertarget{group__doubleSYauxiliary_ga5f95b3cae2a8dc2bdb7f6e336d0c297f}{}\index{double@{double}!dsyswapr@{dsyswapr}}
\index{dsyswapr@{dsyswapr}!double@{double}}
\subsubsection[{dsyswapr}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dsyswapr (
\begin{DoxyParamCaption}
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
...
\item[{integer}]{I2}
\end{DoxyParamCaption}
)}\label{group__doubleSYauxiliary_ga5f95b3cae2a8dc2bdb7f6e336d0c297f}


{\bfseries D\+S\+Y\+S\+W\+A\+P\+R} applies an elementary permutation on the rows and columns of a symmetric matrix. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} DSYSWAPR applies an elementary permutation on the rows and the columns of
...
September 2012 
\end{DoxyDate}
\hypertarget{group__doubleSYauxiliary_gaa6de4c854b216a9afb2f6d00eaaa3b45}{}\index{double@{double}!dtgsy2@{dtgsy2}}
\index{dtgsy2@{dtgsy2}!double@{double}}
\subsubsection[{dtgsy2}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dtgsy2 (
\begin{DoxyParamCaption}
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__doubleSYauxiliary_gaa6de4c854b216a9afb2f6d00eaaa3b45}


{\bfseries D\+T\+G\+S\+Y2} solves the generalized Sylvester equation (unblocked algorithm). 
