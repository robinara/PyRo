\hypertarget{group__complexGBsolve}{}\section{complex}
\label{group__complexGBsolve}\index{complex@{complex}}
...
This is the group of complex solve driver functions for G\+B matrices 

\subsection{Function Documentation}
\hypertarget{group__complexGBsolve_ga9b44557f795536a0e2c2949b894022f7}{}\index{complex@{complex}!cgbsv@{cgbsv}}
\index{cgbsv@{cgbsv}!complex@{complex}}
\subsubsection[{cgbsv}]{\setlength{\rightskip}{0pt plus 5cm}subroutine cgbsv (
...
)}\label{group__complexGBsolve_ga9b44557f795536a0e2c2949b894022f7}


{\bfseries  C\+G\+B\+S\+V computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for G\+B matrices} (simple driver) 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} CGBSV computes the solution to a complex system of linear equations
...
\end{DoxyParagraph}
\hypertarget{group__complexGBsolve_ga887b8e19c54f73b82637b3c2d0b5a178}{}\index{complex@{complex}!cgbsvx@{cgbsvx}}
\index{cgbsvx@{cgbsvx}!complex@{complex}}
\subsubsection[{cgbsvx}]{\setlength{\rightskip}{0pt plus 5cm}subroutine cgbsvx (
\begin{DoxyParamCaption}
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__complexGBsolve_ga887b8e19c54f73b82637b3c2d0b5a178}


{\bfseries  C\+G\+B\+S\+V\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for G\+B matrices} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} CGBSVX uses the LU factorization to compute the solution to a complex
...
April 2012 
\end{DoxyDate}
\hypertarget{group__complexGBsolve_ga366c297439ac18cfefeb91629d44f2cb}{}\index{complex@{complex}!cgbsvxx@{cgbsvxx}}
\index{cgbsvxx@{cgbsvxx}!complex@{complex}}
\subsubsection[{cgbsvxx}]{\setlength{\rightskip}{0pt plus 5cm}subroutine cgbsvxx (
\begin{DoxyParamCaption}
\item[{character}]{F\+A\+C\+T, }
\item[{character}]{T\+R\+A\+N\+S, }
\item[{integer}]{N, }
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__complexGBsolve_ga366c297439ac18cfefeb91629d44f2cb}


{\bfseries  C\+G\+B\+S\+V\+X\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for G\+B matrices} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb}    CGBSVXX uses the LU factorization to compute the solution to a
    ...
    differ from what CGBSVXX would itself produce.\end{DoxyVerb}
