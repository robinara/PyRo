\hypertarget{group__realGTcomputational}{}\section{real}
\label{group__realGTcomputational}\index{real@{real}}
...
\hypertarget{group__realGTcomputational_ga9474585c30f5420fc243d0bd0e0e9c12}{}\index{real@{real}!sgtcon@{sgtcon}}
\index{sgtcon@{sgtcon}!real@{real}}
\subsubsection[{sgtcon}]{\setlength{\rightskip}{0pt plus 5cm}subroutine sgtcon (
...
)}\label{group__realGTcomputational_ga9474585c30f5420fc243d0bd0e0e9c12}


{\bfseries S\+G\+T\+C\+O\+N} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} SGTCON estimates the reciprocal of the condition number of a real
...
September 2012 
\end{DoxyDate}
\hypertarget{group__realGTcomputational_gaa83bbd4b0fcb6e3dffaa4ea7c08b2f08}{}\index{real@{real}!sgtrfs@{sgtrfs}}
\index{sgtrfs@{sgtrfs}!real@{real}}
\subsubsection[{sgtrfs}]{\setlength{\rightskip}{0pt plus 5cm}subroutine sgtrfs (
\begin{DoxyParamCaption}
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__realGTcomputational_gaa83bbd4b0fcb6e3dffaa4ea7c08b2f08}


{\bfseries S\+G\+T\+R\+F\+S} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} SGTRFS improves the computed solution to a system of linear
...
September 2012 
\end{DoxyDate}
\hypertarget{group__realGTcomputational_ga0cd464cdbfc79c87c6b3fa3d1e139abf}{}\index{real@{real}!sgttrf@{sgttrf}}
\index{sgttrf@{sgttrf}!real@{real}}
\subsubsection[{sgttrf}]{\setlength{\rightskip}{0pt plus 5cm}subroutine sgttrf (
\begin{DoxyParamCaption}
\item[{integer}]{N, }
\item[{real, dimension( $\ast$ )}]{D\+L, }
\item[{real, dimension( $\ast$ )}]{D, }
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__realGTcomputational_ga0cd464cdbfc79c87c6b3fa3d1e139abf}


{\bfseries S\+G\+T\+T\+R\+F} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} SGTTRF computes an LU factorization of a real tridiagonal matrix A
...
September 2012 
\end{DoxyDate}
\hypertarget{group__realGTcomputational_ga4c1f4f3382563a295c36917d658befb3}{}\index{real@{real}!sgttrs@{sgttrs}}
\index{sgttrs@{sgttrs}!real@{real}}
\subsubsection[{sgttrs}]{\setlength{\rightskip}{0pt plus 5cm}subroutine sgttrs (
\begin{DoxyParamCaption}
\item[{character}]{T\+R\+A\+N\+S, }
\item[{integer}]{N, }
\item[{integer}]{N\+R\+H\+S, }
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__realGTcomputational_ga4c1f4f3382563a295c36917d658befb3}


{\bfseries S\+G\+T\+T\+R\+S} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} SGTTRS solves one of the systems of equations
    A*X = B  or  A**T*X = B,
...
September 2012 
\end{DoxyDate}
\hypertarget{group__realGTcomputational_ga913327540f64843e724055d28babf247}{}\index{real@{real}!sgtts2@{sgtts2}}
\index{sgtts2@{sgtts2}!real@{real}}
\subsubsection[{sgtts2}]{\setlength{\rightskip}{0pt plus 5cm}subroutine sgtts2 (
\begin{DoxyParamCaption}
...
\item[{integer}]{L\+D\+B}
\end{DoxyParamCaption}
)}\label{group__realGTcomputational_ga913327540f64843e724055d28babf247}


{\bfseries S\+G\+T\+T\+S2} solves a system of linear equations with a tridiagonal matrix using the L\+U factorization computed by sgttrf. 
