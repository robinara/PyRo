\hypertarget{group__doublePTsolve}{}\section{double}
\label{group__doublePTsolve}\index{double@{double}}
...
\hypertarget{group__doublePTsolve_gaf1bd4c731915bd8755a4da8086fd79a8}{}\index{double@{double}!dptsv@{dptsv}}
\index{dptsv@{dptsv}!double@{double}}
\subsubsection[{dptsv}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dptsv (
...
)}\label{group__doublePTsolve_gaf1bd4c731915bd8755a4da8086fd79a8}


{\bfseries  D\+P\+T\+S\+V computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for P\+T matrices} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} DPTSV computes the solution to a real system of linear equations
...
September 2012 
\end{DoxyDate}
\hypertarget{group__doublePTsolve_ga9584fd037291be2dff42741bb3215772}{}\index{double@{double}!dptsvx@{dptsvx}}
\index{dptsvx@{dptsvx}!double@{double}}
\subsubsection[{dptsvx}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dptsvx (
\begin{DoxyParamCaption}
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__doublePTsolve_ga9584fd037291be2dff42741bb3215772}


{\bfseries  D\+P\+T\+S\+V\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for P\+T matrices} 
