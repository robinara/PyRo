\hypertarget{dlalsd_8f}{}\section{packages/lapack-\/3.5.0/\+S\+R\+C/dlalsd.f File Reference}
\label{dlalsd_8f}\index{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/dlalsd.\+f@{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/dlalsd.\+f}}
...
\hypertarget{dlalsd_8f_ad9672df73e817eee614a97daea1341b0}{}\index{dlalsd.\+f@{dlalsd.\+f}!dlalsd@{dlalsd}}
\index{dlalsd@{dlalsd}!dlalsd.\+f@{dlalsd.\+f}}
\subsubsection[{dlalsd}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dlalsd (
...
)}\label{dlalsd_8f_ad9672df73e817eee614a97daea1341b0}


{\bfseries D\+L\+A\+L\+S\+D} uses the singular value decomposition of \hyperlink{classA}{A} to solve the least squares problem. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} DLALSD uses the singular value decomposition of A to solve the least
