\hypertarget{group__doubleGBauxiliary}{}\section{double}
\label{group__doubleGBauxiliary}\index{double@{double}}
...
\begin{DoxyCompactList}\small\item\em {\bfseries D\+L\+A\+N\+G\+B} returns the value of the 1-\/norm, Frobenius norm, infinity-\/norm, or the largest absolute value of any element of general band matrix. \end{DoxyCompactList}\item 
...
This is the group of double auxiliary functions for G\+B matrices 

\subsection{Function Documentation}
\hypertarget{group__doubleGBauxiliary_gaef2185b66fc7b07324cb1dcb622ea238}{}\index{double@{double}!dlangb@{dlangb}}
\index{dlangb@{dlangb}!double@{double}}
\subsubsection[{dlangb}]{\setlength{\rightskip}{0pt plus 5cm}double {\bf precision} {\bf function} dlangb (
...
)}\label{group__doubleGBauxiliary_gaef2185b66fc7b07324cb1dcb622ea238}


{\bfseries D\+L\+A\+N\+G\+B} returns the value of the 1-\/norm, Frobenius norm, infinity-\/norm, or the largest absolute value of any element of general band matrix. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} DLANGB  returns the value of the one norm,  or the Frobenius norm, or
 the  infinity norm,  or the element of  largest absolute value  of an
 n by n band matrix  A,  with kl sub-diagonals and ku super-diagonals.\end{DoxyVerb}

\end{DoxyParagraph}
\begin{DoxyReturn}{Returns}
D\+L\+A\+N\+G\+B \begin{DoxyVerb}    DLANGB = ( max(abs(A(i,j))), NORM = 'M' or 'm'
             (
...
September 2012 
\end{DoxyDate}
\hypertarget{group__doubleGBauxiliary_gad33336cd27dd6f289effc58cf9e88673}{}\index{double@{double}!dlaqgb@{dlaqgb}}
\index{dlaqgb@{dlaqgb}!double@{double}}
\subsubsection[{dlaqgb}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dlaqgb (
\begin{DoxyParamCaption}
\item[{integer}]{M, }
\item[{integer}]{N, }
\item[{integer}]{K\+L, }
...
\end{DoxyParamCaption}
)}\label{group__doubleGBauxiliary_gad33336cd27dd6f289effc58cf9e88673}


{\bfseries D\+L\+A\+Q\+G\+B} scales a general band matrix, using row and column scaling factors computed by sgbequ. 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} DLAQGB equilibrates a general M by N band matrix A with KL
