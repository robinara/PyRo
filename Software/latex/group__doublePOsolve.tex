\hypertarget{group__doublePOsolve}{}\section{double}
\label{group__doublePOsolve}\index{double@{double}}
...
\begin{DoxyCompactList}\small\item\em {\bfseries  D\+P\+O\+S\+V\+X\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for P\+O matrices} \end{DoxyCompactList}\item 
...
This is the group of double solve driver functions for P\+O matrices 

\subsection{Function Documentation}
\hypertarget{group__doublePOsolve_ga9ce56acceb70eb6484a768eaa841f70d}{}\index{double@{double}!dposv@{dposv}}
\index{dposv@{dposv}!double@{double}}
\subsubsection[{dposv}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dposv (
...
)}\label{group__doublePOsolve_ga9ce56acceb70eb6484a768eaa841f70d}


{\bfseries  D\+P\+O\+S\+V computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for P\+O matrices} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} DPOSV computes the solution to a real system of linear equations
    A * X = B,
...
November 2011 
\end{DoxyDate}
\hypertarget{group__doublePOsolve_gac9c72f254642bcc4d512c24c00e47d33}{}\index{double@{double}!dposvx@{dposvx}}
\index{dposvx@{dposvx}!double@{double}}
\subsubsection[{dposvx}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dposvx (
\begin{DoxyParamCaption}
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__doublePOsolve_gac9c72f254642bcc4d512c24c00e47d33}


{\bfseries  D\+P\+O\+S\+V\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for P\+O matrices} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} DPOSVX uses the Cholesky factorization A = U**T*U or A = L*L**T to
...
April 2012 
\end{DoxyDate}
\hypertarget{group__doublePOsolve_ga423141487077727ec3bc52edd1fccd44}{}\index{double@{double}!dposvxx@{dposvxx}}
\index{dposvxx@{dposvxx}!double@{double}}
\subsubsection[{dposvxx}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dposvxx (
\begin{DoxyParamCaption}
\item[{character}]{F\+A\+C\+T, }
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__doublePOsolve_ga423141487077727ec3bc52edd1fccd44}


{\bfseries  D\+P\+O\+S\+V\+X\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for P\+O matrices} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb}    DPOSVXX uses the Cholesky factorization A = U**T*U or A = L*L**T
    ...
    differ from what DPOSVXX would itself produce.\end{DoxyVerb}
...
April 2012 
\end{DoxyDate}
\hypertarget{group__doublePOsolve_ga91ea95252aad898ccba02b2ebd7eab22}{}\index{double@{double}!dsposv@{dsposv}}
\index{dsposv@{dsposv}!double@{double}}
\subsubsection[{dsposv}]{\setlength{\rightskip}{0pt plus 5cm}subroutine dsposv (
\begin{DoxyParamCaption}
\item[{character}]{U\+P\+L\+O, }
\item[{integer}]{N, }
\item[{integer}]{N\+R\+H\+S, }
...
\item[{integer}]{I\+N\+F\+O}
\end{DoxyParamCaption}
)}\label{group__doublePOsolve_ga91ea95252aad898ccba02b2ebd7eab22}


{\bfseries  D\+S\+P\+O\+S\+V computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for P\+O matrices} 

 \begin{DoxyParagraph}{Purpose\+: }
\begin{DoxyVerb} DSPOSV computes the solution to a real system of linear equations
    A * X = B,
 where A is an N-by-N symmetric positive definite matrix and X and B
 are N-by-NRHS matrices.
