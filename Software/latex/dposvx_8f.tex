\hypertarget{dposvx_8f}{}\section{packages/lapack-\/3.5.0/\+S\+R\+C/dposvx.f File Reference}
\label{dposvx_8f}\index{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/dposvx.\+f@{packages/lapack-\/3.\+5.\+0/\+S\+R\+C/dposvx.\+f}}
...
\begin{DoxyCompactList}\small\item\em {\bfseries  D\+P\+O\+S\+V\+X computes the solution to system of linear equations \hyperlink{classA}{A} $\ast$ X = B for P\+O matrices} \end{DoxyCompactList}\end{DoxyCompactItemize}
