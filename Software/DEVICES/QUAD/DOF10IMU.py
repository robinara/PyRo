...
class imu(threading.Thread):
	...
	def __init__(self,MODEL):
		...
		self.l3gd20		= driver.L3GD20.L3GD20(busId = 1, slaveAddr = 0x6b, ifLog = False, ifWriteBlock=False)
	...
	def run(self):
		...
		while self.isRunning:
			...
			#print imu[0][0]
			self.model.x_accel = (self.model.x_accel+imu[0][0])/2.0
			self.model.y_accel = (self.model.y_accel+imu[0][1])/2.0
